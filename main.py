...
lula_total_votes += int(states[state] * lula_percentage)
bolsonaro_total_votes += int(states[state] * bolsonaro_percentage)

print("lula", lula_total_votes, "bolso", bolsonaro_total_votes)
